...
public class PruebaInsertarDB {
	...
	public void InsertarYEliminarUsuarioTest() {
		...
		// correspondiente
		Usuario usuarioPrueba = new Usuario(0, "Prueba", 50, 10, TipoAtraccion.AVENTURA);
		userDao.insert(usuarioPrueba);
		assertEquals(usuarioPrueba.getNombreDeUsuario(), userDao.findByName("Prueba").getNombreDeUsuario());
		assertEquals(usuarioPrueba.getDineroDisponible(), userDao.findByName("Prueba").getDineroDisponible(), 0.001);
		assertEquals(usuarioPrueba.getTiempoDisponible(), userDao.findByName("Prueba").getTiempoDisponible(), 0.001);
		assertEquals(usuarioPrueba.getPreferencia(), userDao.findByName("Prueba").getPreferencia());
		userDao.delete(usuarioPrueba);
	...
	public void InsertarYEliminarItinerarioTest() {
		...
		Itinerario itinPrueba = new Itinerario(usuarioPrueba.getIdUsuario(), nuevaAtraccion1.getIdProducto(), 0);
	...
	public void InsertarYEliminarPromoPorTest() {
		...
		assertEquals(promoPor.getNombreProducto(), producto.getNombreProducto());
	...
	public void InsertarYEliminarPromoAbsTest() {
		...
		assertEquals(promoAbs.getNombreProducto(), producto.getNombreProducto());
	...
	public void InsertarYEliminarPromoAxBTest() {
		...
		assertEquals(promoAxB.getNombreProducto(), producto.getNombreProducto());
